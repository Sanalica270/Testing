...
public class Data {
	public static String usersPath = "src\\users.xlsx";
	public static String productsPath = "src\\products.xlsx";
	private static String file = "products.xlsx";
	...
	public static void readText() throws Exception {
		p = new Properties();
		FileReader read = new FileReader("B:\\workspace\\testing\\src\\lokatori.txt");
		p.load(read);
	}
